...
namespace SFA.DAS.Data.Functions.UnitTests.Psrs
{
    ...
    public class WhenTheCreatePsrsReportSubmissionsSummaryFunctionIsRun
    {
        ...
        public async Task ThenTheCreatePsrsSubmittedReportsMethodIsInvoked()
        {
            ...
            _reportsService.Verify(o => o.CreatePsrsReportSubmissionsSummary(), Times.Once);
        }

        private async Task InvokeRunMethodOnFunction()
        {
            await CreatePsrsReportSubmissionsSummaryFunction.Run(null, _logger.Object, _reportsService.Object);
        }
    }
}
