...
{
    [TestFixture]
    public class WhenAnAccountIsRenamed
    {
        ...
        private async Task<bool> IsDatabaseInExpectedState()
        {
            ...
            var numberOfAccounts = await _eventTestsRepository.GetNumberOfAccounts();
        ...
        private void ConfigureAccountsApi(List<AccountEventView> events)
        {
            ...
            _accountsApi.SetupGet("api/accounts/ABC123v2", new AccountDetailViewModelBuilder().WithDasAccountId("ABC123").WithName("New Name").Build());
        }
