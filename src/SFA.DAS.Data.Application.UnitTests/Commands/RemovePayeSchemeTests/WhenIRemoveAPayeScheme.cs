...
namespace SFA.DAS.Data.Application.UnitTests.Commands.RemovePayeSchemeTests
{
    [TestFixture]
    public class WhenIRemoveAPayeScheme
    {
        private RemovePayeSchemeCommandHandler _commandHandler;
        ...
        public void Arrange()
        {
            ...
            _commandHandler = new RemovePayeSchemeCommandHandler(_payeSchemeRepository.Object, _accountGateway.Object);
        }
        ...
        public async Task ThenThePayeSchemeIsRetrievedAndSaved()
        {
            ...
            await _commandHandler.Handle(new RemovePayeSchemeCommand { PayeSchemeHref = payeSchemeHref });
