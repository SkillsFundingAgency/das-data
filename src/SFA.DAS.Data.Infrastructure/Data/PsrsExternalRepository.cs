...
namespace SFA.DAS.Data.Infrastructure.Data
{
    public class PsrsExternalRepository : BaseRepository, IPsrsExternalRepository
    {
        ...
        public async Task<IEnumerable<ReportSubmitted>> GetSubmittedReports(DateTime lastRun)
        {
            ...
            NULLIF(JSON_VALUE([ReportingData], '$.Questions[1].SubSections[0].Questions[0].Answer'), '') AS Answer4_1,
            ...
            NULLIF(JSON_VALUE([ReportingData], '$.Questions[1].SubSections[1].Questions[0].Answer'), '') AS Answer5_1,
            ...
            NULLIF(JSON_VALUE([ReportingData], '$.Questions[1].SubSections[2].Questions[0].Answer'),'') AS Answer6_1,
            ...
            NULLIF(JSON_VALUE([ReportingData], '$.Questions[1].SubSections[3].Questions[0].Answer'), '') AS Answer7_1,
