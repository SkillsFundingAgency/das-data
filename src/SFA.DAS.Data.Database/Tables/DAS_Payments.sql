...
GO
CREATE INDEX [IX_Payment_CollectionYear] ON [Data_Load].[DAS_Payments] ([CollectionYear]) INCLUDE ([CollectionMonth], [ContractType], [DeliveryMonth], [DeliveryYear], [EmployerAccountId], [FundingSource])