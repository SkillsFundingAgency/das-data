...
INSERT INTO HMRC.Configuration_Data_Quality_Tests
    ...
    , ColumnMinValue
    , ColumnMaxValue
    , FlagStopLoadIfTestTextLenght 
    , FlagStopLoadIfTestIsNumeric 
    , FlagStopLoadIfTestPatternMatch 
    , FlagStopLoadIfTestValueRange 
    , FlagStopLoadIfTestDecimalPlaces 
    )
SELECT 'TaxPeriodStartYear' AS ColumnName, 1 AS ColumnNullable , 'INT' AS ColumnType, '' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '20[1-9][0-9]' AS ColumnPatternMatching, '2016' AS ColumnMinValue, '9999' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,1 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
UNION ALL SELECT 'TaxPeriodMonth' AS ColumnName, 1 AS ColumnNullable , 'INT' AS ColumnType, '' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '1' AS ColumnMinValue, '12' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,1 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
UNION ALL SELECT 'SchemePAYERef' AS ColumnName, 1 AS ColumnNullable , 'VARCHAR' AS ColumnType, '14' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '[0-9][0-9][0-9]/[A-Z]%' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
UNION ALL SELECT 'AccountsOfficeRef' AS ColumnName, 1 AS ColumnNullable , 'VARCHAR' AS ColumnType, '13' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
UNION ALL SELECT 'UniqueTaxReference' AS ColumnName, 1 AS ColumnNullable , 'VARCHAR' AS ColumnType, '10' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
...
UNION ALL SELECT 'RegisteredName' AS ColumnName, 1 AS ColumnNullable , 'VARCHAR' AS ColumnType, '56' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
UNION ALL SELECT 'RegisteredAddressLine1' AS ColumnName, 1 AS ColumnNullable , 'VARCHAR' AS ColumnType, '35' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
...
UNION ALL SELECT 'CessationDate' AS ColumnName, 1 AS ColumnNullable , 'Date' AS ColumnType, '' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
...
UNION ALL SELECT 'AlternativeAddressLine4' AS ColumnName, 1 AS ColumnNullable , 'VARCHAR' AS ColumnType, '30' AS ColumnLength, '' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatching, '' AS ColumnMinValue, '' AS ColumnMaxValue,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
...
UNION ALL SELECT 'HistoricAdjustmentsTaxMonth6AnnualAllowanceAmount' AS ColumnName, 1 AS ColumnNullable , 'DECIMAL' AS ColumnType, '18' AS ColumnLength, '2' AS ColumnPrecision, '' AS ColumnDefault, 1 as RunColumnTests, '' AS ColumnPatternMatch, '' AS ColumnMinValue, '' AS ColumnMaxValueing,0 AS FlagStopLoadIfTestTextLenght,0 AS FlagStopLoadIfTestIsNumeric,0 AS FlagStopLoadIfTestPatternMatch,0 AS FlagStopLoadIfTestValueRange,0 AS FlagStopLoadIfTestDecimalPlaces
