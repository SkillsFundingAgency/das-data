...
namespace SFA.DAS.Data.Functions.Transfers
{
    public class ProcessTransferRelationshipRejectedMessage
    {
        ...
        public static void Run([ServiceBusTrigger("sent_transfer_connection_invitation", "RDS_RejectedTransferConnectionInvitiationProcessor", AccessRights.Manage,Connection = "MessageBusConnectionString")] RejectedTransferConnectionInvitationEvent Message, ExecutionContext executionContext, TraceWriter log)
        {
